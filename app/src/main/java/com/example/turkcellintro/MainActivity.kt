...
// Class => :ComponentActivity() -> Kalıtım almak
// Kendi oluşturduğum MainActivity classına Component olma özelliğini ekledim.

// mainActivity: subclass
// componentActivity: superclass
class MainActivity : ComponentActivity() {

    // override => kalıtım aldığım classdaki bir methodu değiştirmek/geliştirmek
